...
<section class="relative w-full px-[2.5%] md:px-[3.5%] lg:px-[7.5%] xl:px-[8.68%] mx-auto pt-3 xl:pt-[97px] pb-6 overflow-hidden">
  ...
  <div class="relative z-20 flex flex-col lg:flex-row items-center xl:items-start justify-center lg:justify-between gap-8 lg:gap-6 xl:gap-12 w-full max-w-[1300px] mx-auto text-center lg:text-left">
    ...
    <!-- SVG BACKGROUND -->
    <div class="animate-pulse absolute top-2 left-2 xl:-top-[42px] xl:-left-[45px] z-10 opacity-100">
    ...
    <div class="about-left py-[13px] w-full lg:w-6/12 flex flex-col items-center lg:items-start gap-5">
      ...
      <?php if ( ! empty( $about_title ) ) : ?>
        <h2 data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500" class="home-heading pt-8 md:pt-0">
     ...
     data-aos-delay="300"
     data-aos-offset="0" class="text-black dark:text-white max-w-[533px] font-jost text-base md:text-[19px] leading-normal tracking-[0.38px]">
  ...
  <!-- RIGHT IMAGE FIXED -->
<div data-aos="zoom-in-left" class="relative w-full lg:w-6/12 flex justify-center lg:justify-end">

  <?php if ( ! empty( $about_image ) ) : ?>

    <!-- FIX WRAPPER -->
    <div class="relative w-full mx-auto max-w-[624px] aspect-[624/495] overflow-hidden">
      ...
      <!-- OVERLAY -->
      <div class="absolute inset-0 bg-white/10 dark:hidden pointer-events-none"></div>

      <!-- CTA BUTTON FIXED -->
      <a href="<?php echo esc_url( $enter_link ); ?>"
         class="absolute bottom-0 right-0 w-full z-30">

        <div class="w-[98%] h-[89px] bg-[#16396F] flex items-center justify-center relative" style="clip-path: polygon(29px 0, 100% 0, 100% 100%, 0 100%);">

          <?php if ( ! empty( $about_button_text ) ) : ?>
            <span class="relative z-50 text-white font-bebas-pro text-[30px] sm:text-[40px] md:text-[44px] lg:text-[50px] font-bold uppercase">
