...
<section class="relative w-full max-w-[1440px] -mb-10 mt-6 sm:mt-8 md:mt-12 lg:mt-14 xl:mt-20 2xl:mt-[100px]"
    style="background: linear-gradient(0deg,rgba(0,0,0,0.50) 0%,rgba(0,0,0,0.50) 100%), url('<?php echo esc_url($bg_image); ?>') center/cover no-repeat;">

    <div class="absolute inset-0 bg-[#00000080] opacity-5"></div>

    <div
        class="relative z-20 content px-[5%] sm:px-[7%] md:px-[4%] lg:px-[5%] xl:pl-[6.5%] py-10 sm:py-14 md:py-16 lg:py-20 flex flex-col lg:flex-row gap-10 sm:gap-12 lg:gap-[54px] max-w-[1330px] mx-auto">

        <!-- left card -->
        <div class="left w-full lg:w-[60%] xl:w-[49.2%]">
            <div
                class="w-full h-auto  pt-6 sm:pt-8 lg:pt-[37.86px] pl-5 sm:pl-6 lg:pl-[39.50px] dark:bg-gray-300 bg-white shadow-[ -12px_49px_94px_0_rgba(85,89,90,0.05) ] rounded-lg flex flex-col items-center justify-center lg:justify-start lg:items-start mx-auto">
                <h2
                    class="text-[#01112D] font-bebas text-[28px] sm:text-[34px] md:text-[36px] lg:text-[38px] leading-[1.2]">
                    <?php echo esc_html($title); ?>
                </h2>
                <h3
                    class="text-[rgba(25,43,71,0.8)] font-dm-sans text-[14px] sm:text-[15px] md:text-[16px] leading-[22.4px] mt-1.5">
                    <?php echo esc_html($desc); ?>
                </h3>

                <div class="form-data pr-4 sm:pr-5 md:pr-6 -mt-10">
                    <?php
                    // echo do_shortcode('[contact-form-7 id="ec82a1f" title="Child Entry Form"]'); 
                    ?>
                    <?php echo do_shortcode('[contact-form-7 id="3e2f808" title="Child Entry Form"]'); ?>
                </div>
            </div>
        </div>
        ...
        <div
            class="right-text-button flex w-full lg:w-[40%] xl:w-[50.8%] flex-col gap-5 justify-center pt-10 sm:pt-14 md:pt-20 lg:pt-[175px] text-center lg:text-left max-w-[70%] lg:max-w-[100%] mx-auto pr-3">
            <h3
                class="font-bebas text-white w-full sm:w-[90%] lg:w-full text-[26px] sm:text-[32px] md:text-[36px] lg:text-[40px] leading-[1.2] tracking-[0.8px]">
