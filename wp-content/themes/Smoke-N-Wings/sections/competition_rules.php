<section class="relative w-[1440px] mx-auto">
    ...
    <div class="relative z-20 px-[125px] pt-[95px] w-full">
        ...
        <div class="heading flex items-center justify-center flex-col gap-4">
            ...
            <h2 class="text-[#16396F] text-center font-bebas-pro text-[60px] font-normal leading-[81px] tracking-[1.2px] uppercase">
        ...
        <div class="div flex flex-col gap-4">
            ...
            <!-- card wrapper -->
            <div class="card-wrapper -ml-3 pt-11 grid grid-cols-2 gap-x-11 gap-y-8 items-center justify-center">
                <?php
                $rules = new WP_Query([
                    'post_type'      => 'post',
                    'posts_per_page' => 4,
                ...
                if ($rules->have_posts()):
                    while ($rules->have_posts()): $rules->the_post(); ?>
                        ...
                        <div class="w-[588.47px] h-[660.814px] flex-shrink-0 border-[1.08px] border-[#E7E7E7] bg-[rgba(255,228,213,0.40)] overflow-hidden">
                            ...
                            <!-- Content -->
                            <div class="px-[33.73px] py-[30px] flex flex-col gap-4">
                                ...
                                <!-- Description -->
                         <h3 class="text-[#7C7C7C] pl-2 pb-2 mt-1 font-jost text-[20px] font-normal leading-[28px] not-italic w-[430px] break-words">
